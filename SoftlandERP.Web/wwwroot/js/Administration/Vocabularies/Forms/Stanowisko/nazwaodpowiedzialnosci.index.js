            ...
            buttons: [
                {
                    ...
                    action: function () {
                        $.LoadingOverlay("show");
                        $.ajax({
                            url: "/Administration/FormsStanowiskoNazwaOdpowiedzialnosci/Create",
                    ...
                    buttons: [
                        {
                            text: 'Cała baza',
                            action: function () {
                                window.location.href = '/Administration/FormsStanowiskoNazwaOdpowiedzialnosci/ExportExcel';
                            }
                        },
                        {
                            extend: 'excel',
...
(function ($) {
    ...
    $('#datatable').on("click", '#delete-button', function () {
        ...
        var id = $(this).data("id");
        $.ajax({
            url: "/Administration/FormsStanowiskoNazwaOdpowiedzialnosci/Delete",
            data: { id: id },
            success: function (response) {
                $.LoadingOverlay("hide");
                $("#modal-content").html(response);
