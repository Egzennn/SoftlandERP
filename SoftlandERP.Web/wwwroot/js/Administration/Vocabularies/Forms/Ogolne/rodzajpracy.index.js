            ...
            buttons: [
                {
                    ...
                    action: function () {
                        $.LoadingOverlay("show");
                        $.ajax({
                            url: "/Administration/FormsOgolneRodzajPracy/Create",
                    ...
                    buttons: [
                        {
                            text: 'Ca³a baza',
                            action: function () {
                                window.location.href = '/Administration/FormsOgolneRodzajPracy/ExportExcel';
                            }
                        },
                        {
                            extend: 'excel',
...
(function ($) {
    ...
    $('#datatable').on("click", '#delete-button', function () {
        ...
        var id = $(this).data("id");
        $.ajax({
            url: "/Administration/FormsOgolneRodzajPracy/Delete",
            data: { id: id },
            success: function (response) {
                $.LoadingOverlay("hide");
                $("#modal-content").html(response);
