            ...
            buttons: [
                {
                    ...
                    action: function () {
                        $.LoadingOverlay("show");
                        window.location.href = '/Forms/SpedycjaKonfekcjaForm/Create';
                        $.LoadingOverlay("hide");
                    }
                },
                {
                    ...
                    buttons: [
                        {
                            text: 'Cała baza',
                            action: function () {
                                window.location.href = '/Forms/SpedycjaKonfekcjaForm/ExportExcel';
                            }
                        },
                        {
                            extend: 'excel',
...
(function ($) {
    $('#datatable').on("click", '#modify-button', function () {
        ...
        $.ajax({
            ...
            url: "/Forms/SpedycjaKonfekcjaForm/Create",
            data: { id: id },
        });
    });
    $('#datatable').on("click", '#delete-button', function () {
        ...
        var id = $(this).data("id");
        $.ajax({
            url: "/Forms/SpedycjaKonfekcjaForm/Delete",
            data: { id: id },
