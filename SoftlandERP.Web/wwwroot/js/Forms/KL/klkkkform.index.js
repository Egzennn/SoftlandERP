    ...
    var datatableInit = function () {
        ...
        var fnFormatDetails = function (datatable, tr) {
            ...
            return [
                ...
                '</tr>',
                '<tr class="b-top-0">',
                '<td style="width: 200px;"><label class="mb-0">Rekomendacja:</label></td>',
                '<td>' + data[9] + '</td>',
                '</tr>',
                '<tr class="b-top-0">',
                '<td style="width: 200px;"><label class="mb-0">Waga:</label></td>',
                '<td>' + data[10] + '</td>',
                '</tr>',
                '<td style="width: 200px;"><label class="mb-0">Sprawy powiązane:</label></td>',
                '<td>' + data[11] + '</td>',
                '</tr>',
                '<tr>',
            ...
            buttons: [
                {
                    ...
                    attr: {
                        id: "addStanDataTableButton"
                    },
                    action: function () {
                        $.LoadingOverlay("show");
                        $.ajax({
                            url: "/Forms/KLKKKForm/Create",
                    ...
                    buttons: [
                        {
                            text: 'Cała baza',
                            action: function () {
                                window.location.href = '/Forms/KLKKKForm/ExportExcel';
                            }
                        },
                        {
                            extend: 'excel',
