...
{
    [Area("Administration")]
    public class QuotaToolController : BaseController
    {
        public static readonly string ModuleName = "Wpisy przydziału dyskrowego";

        private readonly ADConfiguration adConfiguration;

        public QuotaToolController(IADRepository adRepository, IRepository<HelperText> helperTextRepository, IToastNotification toastNotification, ILogger<BaseController> logger, IOptions<ADConfiguration> adConfiguration)
